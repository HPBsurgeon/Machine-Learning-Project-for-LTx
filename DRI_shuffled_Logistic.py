...
for i in tqdm.tqdm(range(100)):
    ...
    for j in tqdm.tqdm(range(k)):
        x_train, x_test, t_train, t_test_l = train_test_split(x, t, test_size = 1/k)#testsizeを0.09などにすると精度が良くなった。これをここに入れるのが肝。splitの最適化をしにいっているようなもの
        ...
        auc_k.append(roc_auc_score(t_test_l, proba_l))
